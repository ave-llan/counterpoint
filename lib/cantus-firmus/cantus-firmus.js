var createCFguide = require('./create-cf-guide.js')
  , Pitch = require('nmusic').Pitch
  , intervalSize = require('nmusic').intervalSize
  , sortPitches = require('../utils/sort-pitches.js')
  , prettyPrint = require('./pretty-print-cf.js')
...
var CantusFirmus = function (key, maxRange, maxLength) {
   ...
   * See {@link prettyPrintCf}
   * @returns {string} a simple visualization of the cantus firmus
   */
  this.print = function () {
  ...
  /**
   * @returns {KeyString} the key of this cantus firmus
   */
  this.key = function () {
    return key
  }
